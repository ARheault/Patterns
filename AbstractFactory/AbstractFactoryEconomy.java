...
public class AbstractFactoryEconomy implements AbstractFactoryIF {
     ...
     */
      ...
      */
    public AccountIF makeAccount(int loginId){ return new AccountEconomy(loginId); }
    ...
    public SecurityManagerIF makeSecurityManager() { return new SecurityManagerEconomy(); } 
}
