...
public class AccountEconomy extends AccountIF {
     ...
     * 
     * @param loginId The login id of this account. The login Id is used to retrieve
     *                from a database persistent data, such as the number of
     *                connection hours already used during the current month.
     */
